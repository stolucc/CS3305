...
class PublicationsForm(FlaskForm):
    ...
    choices=[('original', 'Refereed Original Article'), ('review', 'Refereed Review Article'),
    ('conference', 'Refereed Conference Paper'),('book','Book'),('report','Technical Report')])
    title = StringField("Title", validators=[DataRequired()])
...
class PresentationsForm(FlaskForm):
    ...
    choices=[('conference', 'Conference'), ('seminar', 'Invited Seminar'),('keynote','Keynote')])
...
class AcademicColabForm(FlaskForm):
    ...
    choices=[('access', 'Access to Software/Data/Material/Equipment'),('training', 'Training and Career Development'),
    ('publication', 'Joint Publication'), ('startup', 'Startup Development'),('license','License Development'),
...
class FundingRatioForm(FlaskForm):
    ...
    choices=[('twenty', '0-20'),('forty', '21-40'),('sixty', '41-61'),('eighty', '61-81'),('hundred', '81-100')])
    submit = SubmitField("Save")
...
class PublicEngagementForm(FlaskForm):
    ...
    choices=[('local', 'Local (specify County)'),('national', 'National'),('international', 'International')])
    primary_attribution = StringField("Primary Attribution", validators=[DataRequired()])
    submit = SubmitField("Save")
